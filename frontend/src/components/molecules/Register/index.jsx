...
function Register() {
    ...
    return (
        <Container>
            ...
            />
            <span
                style={{width: '85%', display: 'inline-block',textAlign: 'justify', lineHeight: 1.4, whiteSpace:'pre-wrap', fontSize: '13px', margin: '0 15px 25px', padding: '10px', background:'#f1f1f1',borderRadius:'5px'}}
            >
