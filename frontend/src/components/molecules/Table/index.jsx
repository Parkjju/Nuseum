...
const Table = ({
    ...
    const ProcessedFood = {
        '풀무원 리코타 고구마 5MIX 브런치 샐러드' : '고구마, 리코타치즈, 견과류',
        '포켓샐러드 쉬림프 씨위드 두부면 샐러드' : '야채, 고구마, 두부면, 새우, 해조류',
        '스윗밸런스 연어와 리코타치즈 발사믹 샐러드' : '연어, 리코타치즈, 야채',
    ...
    return (
        ...
        >
            ...
            <Name style={{ fontSize: '13px',fontWeight: 400,
                ...
                borderRadius: '5px',
                width: '80%'}}>
                식이일기를 작성해 주시면, 지난 한주의 식이내용이 그림자로 채워집니다.
                부족한 식이내용을 장보기 및 음식주문에 활용해 보세요. ( ), 100g 당 함량
            </Name>
