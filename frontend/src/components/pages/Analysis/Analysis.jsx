                                ...
                                <>
                                    ...
                                    <S.NutrientBox>
                                        ...
                                        >
                                            ...
                                            Nutrition & Dietetics 및 Food Science & Technology 분야 top 1-3위 저널에서
                                             ...
                                             관련 영양성분 및 섭취성분을 선별하였습니다
                                                ...
                                                <Name>
                                                    ...
                                                    식이섬유
                                                    <S.NameDetail>
                                                        장내미생물의 먹이로 이용 | 장내미생물-장-뇌 축에 작용 | 배변활동 원활에 도움을 줄수 있음
                                                    </S.NameDetail>
                                                </Name>
                                                <Name>
                                                    {/* {(
                                        ...
                                        <S.NutrientList>
                                            ...
                                            >
                                                    <Name
                                                        style={{ fontWeight: 400, fontSize: '14px', padding: '8px 0' }}
                                                    >
                                                        {lang
                                                            ? 'Dietary fiber'
                                                            : '식이섬유'}{' '}
                                            ...
                                            >
                                                    <Name
                                                        style={{
                                                            fontWeight: 400, fontSize: '14px', padding: '8px 0' }}
                                                    >
                                                        DHA+EPA{' '}
                                                        {(
                                                            (nutrition.dha_epa /
